...
max_rows_count_1 = []
max_rows_count_2 = []
with open(input_file, 'r', encoding='utf-8') as infile, open(peakmost_file, 'w', encoding='utf-8', newline='') as outfile:
    ...
    for i, (count, row) in enumerate(max_rows_count_2):
        writer.writerow(row)
with open(input_file, 'r', encoding='utf-8') as infile, open(peakleast_file, 'w', encoding='utf-8', newline='') as outfile:
    reader = csv.reader(infile)
    headers = next(reader)
    writer = csv.writer(outfile)
    writer.writerow(headers)
